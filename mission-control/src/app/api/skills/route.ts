...
export async function GET(
  ...
  // This handler is for dynamic routes like /api/skills/[name]
  // Next.js will automatically route to this handler when a skill name is provided
  // For the collection endpoint (/api/skills), the first handler above is used
